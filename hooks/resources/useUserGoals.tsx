...
export const getGoals = (userId: string) => api.get(`/v1/users/${userId}/goals`);
export const updateUserGoals = (userId: string, goals: CareerGoalType[]) => api.put(`/v1/users/${userId}/goals`, {goals});