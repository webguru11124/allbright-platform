  ...
  const filteredJobStatuses = useMemo(
    () =>
      searchText !== undefined
        ? jobStatus.filter((val) => val.value.toLowerCase().includes(searchText?.toLowerCase()))
        : jobStatus,
    [searchText]
  );
        ...
        <View style={[styles.centeredView]}>
          <View style={[styles.modalView]}>
            <View style={[styles.titleContainer]}>
              <CM style={[styles.title]}>Job Status</CM>
...
export default withTheme(JobStatusPicker);
