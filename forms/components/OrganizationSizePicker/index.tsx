...
const OrganizationSizePicker = ({ theme, onChangeText, placeholder, onBlur, error, value }: Props) => {
  ...
  const filteredOrgSizes = useMemo(
    () =>
      searchText !== undefined
        ? organizationSize.filter((val) => val.value.toLowerCase().includes(searchText?.toLowerCase()))
        : organizationSize,
    [searchText]
  );
        ...
        <View style={[styles.centeredView]}>
          <View style={[styles.modalView]}>
            <View style={[styles.titleContainer]}>
              <CM style={[styles.title]}>Org. Size</CM>
